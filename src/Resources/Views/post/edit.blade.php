...
@section('content')
        ...
        @foreach($posts as $post)
            ...
            @elseif($post['type'] == 'image')
                ...
                <div class="text-end my-4">
                    <img class="rounded shadow-lg" src="{{ json_decode($post['path'])[0] }}" width="250">
                </div>
            ...
            @elseif($post['type'] == 'list')
                ...
                <div class="d-flex"><textarea data-type="list" class="form-control my-2 myElm">{{ $post['value'] }}</textarea><span onclick="removeElm(this.parentElement)" class="btn-close"></span></div>
    ...
    @endforeach
        ...
        <div class="d-flex justify-content-between">
            <div>
                <button type="button" class="btn btn-warning m-4" data-bs-toggle="modal" data-bs-target="#exampleModal">+</button>
            </div>
            <div>
